...
abstract final class AppCopy {
  static const _copy = <String, Map<String, String>>{
    'en': {
      ...
      'login.signIn': 'Welcome back',
      'login.emailHint': 'your@email.com',
      'login.emailHelp': 'Share proof. Find trust.',
      'login.journeyLine': 'Sign in to continue your journey',
      'login.journeyPrefix': 'towards a more ',
      'login.journeyTrust': 'trusted',
      'login.journeySuffix': ' world.',
    ...
    'hi': {
      ...
      'login.signIn': 'वापसी पर स्वागत है',
      'login.emailHint': 'your@email.com',
      'login.emailHelp': 'सबूत बांटें. भरोसा पाएं.',
      'login.journeyLine': 'अपना सफर जारी रखें',
      'login.journeyPrefix': 'और ज्यादा ',
      'login.journeyTrust': 'भरोसेमंद',
      'login.journeySuffix': ' दुनिया की ओर.',
      'login.continueEmail': 'ईमेल से जारी रखें',
      'login.continueGoogle': 'गूगल से जारी रखें',
      ...
      'onboarding.languageHelp': 'इसे आप सेटिङ्ग में कभी भी बदल सकते हैं.',
  ...
  static const _phrases = <String, Map<String, String>>{
    'hi': {
      ...
      'Share echo': 'इको शेयर करें',
      'Copy link': 'लिंक कॉपी करें',
      'Report echo': 'इको रिपोर्ट करें',
      'Delete echo': 'इको हटाएं',
      ...
      'Post echoes': 'इको को पोस्ट करें',
      'Support & challenge echoes': 'इकोको सपोर्ट और चैलेंज करें',
      'Character limit': 'कैरेक्टर सीमा',
      'Edit your echoes': 'अपने echoes एडिट करें',
      'Ad-free experience': 'विज्ञापन-मुक्त अनुभव',
      'Truth bonds': 'Truth बोन्ड्स',
