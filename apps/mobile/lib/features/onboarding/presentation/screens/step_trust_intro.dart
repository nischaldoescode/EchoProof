// onboarding step 4: trust system explanation
// shows tier ladder with animated reveal
...
class StepTrustIntro extends ConsumerStatefulWidget {
  const StepTrustIntro({super.key});

  @override
  ConsumerState<StepTrustIntro> createState() => _StepTrustIntroState();
}

class _StepTrustIntroState extends ConsumerState<StepTrustIntro>
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Your interactions shape truth.', style: AppTypography.textTheme.headlineMedium),
